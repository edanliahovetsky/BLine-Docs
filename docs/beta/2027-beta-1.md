...
!!! warning "Prerelease guide — beta not yet released"
    This page describes the proposed **v1.0.0-beta.1** release, reviewed at source revision `05dae92695e630a52a84852ea96cad582b06390f`. Desktop acceptance testing and release approval are still pending. The current website and ordinary editor tutorials remain on **v0.1.0-alpha.12**.
...
| 2027 Beta 1, pending release | [Planned beta address](https://web-beta.bline-web.pages.dev/) — availability is not yet confirmed | **BLine Web Beta**; version-specific installers are pending publication |

After publication, use the release named **BLine Web 2027 Beta 1** with tag **v1.0.0-beta.1** on [GitHub Releases](https://github.com/edanliahovetsky/BLine-Web/releases). A newer prerelease in the release list may belong to a different editor version.
...
New beta archives preserve the project's name and identity. Legacy archives without an identity receive a fresh project ID on import. If an imported identity is already saved in this browser, **Could not import** explains that the project already exists. Open it from the project list; the saved copy is kept intact.
