...
!!! warning "Early beta"
    This guide covers **v1.0.0-beta.1**, verified against source revision `a66fdcb5262505826bc8300aacce80fda0c0b471`. Test existing projects on copies. The current website and ordinary editor tutorials remain on **v0.1.0-alpha.12**.
