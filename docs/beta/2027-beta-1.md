...
!!! warning "Prerelease guide — beta not yet released"
    This page describes the proposed **v1.0.0-beta.1** release, provisionally reviewed at source revision `32a9ce6015184fad4c794ed6e93df9b8f5ac516b`. Final candidate validation is still pending. The current website and ordinary editor tutorials remain on **v0.1.0-alpha.12**.
