...
!!! warning "Prerelease guide — beta not yet released"
    This page describes the proposed **v1.0.0-beta.1** release, provisionally reviewed at source revision `376e7db4dc5f5bea625dd99edc230af4f9eb6e83`. Final candidate validation is still pending. The current website and ordinary editor tutorials remain on **v0.1.0-alpha.12**.
